...
const Post = () => {
    ...
    const { titulo, descricao, imageFile, tags } = placeData;
        ...
        try {
            if (titulo && descricao) {
                ...
                if (user?.id !== undefined) {
                    await createPalce(user?.id, placeData);
                }

                navigate(`/perfil/${user?.id}`, { state: "Postagem cridada com sucesso" });
            }
        } catch (error) {
            ...
            <div className="post-box">
                ...
                onKeyDown={(event) => {
                    ...
                    <div className="first-form-post">
                        ...
                        <div className="input-box" style={{ marginBottom: "20px" }} onClick={(e) => {
                            e.stopPropagation()
                        ...
                        <Tags
                            onChange={tags => {
                                setPlaceData({ ...placeData, tags: tags });
                            }}
                        ...
                        <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
                            ...
                            {errors?.imageError && (
                                <p className="error-msg" style={{ marginTop: "-15px", marginBottom: "15px" }}>{errors.imageError}</p>
                            )}
                        </div>
                    </div>
